...
void _taskSerialize(
  ...
  writer.writeString(offsets[2], object.taskText);
}
...
Task _taskDeserialize(
  ...
  object.taskText = reader.readStringOrNull(offsets[2]);
  return object;
}
...
extension TaskQueryFilter on QueryBuilder<Task, Task, QFilterCondition> {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> taskTextIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> taskTextIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> taskTextEqualTo(
    String? value, {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> taskTextGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> taskTextLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> taskTextBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> taskTextStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> taskTextEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> taskTextContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> taskTextMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> taskTextIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'taskText',
        value: '',
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> taskTextIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'taskText',
        value: '',
...
extension TaskQuerySortBy on QueryBuilder<Task, Task, QSortBy> {
  ...
  QueryBuilder<Task, Task, QAfterSortBy> sortByTaskText() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'taskText', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> sortByTaskTextDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskQuerySortThenBy on QueryBuilder<Task, Task, QSortThenBy> {
  ...
  QueryBuilder<Task, Task, QAfterSortBy> thenByTaskText() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'taskText', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> thenByTaskTextDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'taskText', Sort.desc);
    });
  }
...
extension TaskQueryWhereDistinct on QueryBuilder<Task, Task, QDistinct> {
  ...
  QueryBuilder<Task, Task, QDistinct> distinctByTaskText(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TaskQueryProperty on QueryBuilder<Task, Task, QQueryProperty> {
  ...
  QueryBuilder<Task, String?, QQueryOperations> taskTextProperty() {
    return QueryBuilder.apply(this, (query) {
